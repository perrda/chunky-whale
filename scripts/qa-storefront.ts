...
assert.match(logoSrc, /chunky-whale-light\.png/);
assert.match(logoSrc, /chunky-whale-dark\.png/);
assert.doesNotMatch(logoSrc, /STACKHOUSE|StackHouse|BitcoinMark/);
...
assert.match(getProduct("stackhouse-est-tee")?.editionId ?? "", /^SH-/);
