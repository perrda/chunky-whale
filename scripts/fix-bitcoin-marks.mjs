...
const SKIP = new Set([
  ...
  "bitcoin-mummy-hoodie.png",
  "four-year-hoodie.png",
  "21m-hoodie.png",
  "21m-pullover.png",
  "hodl-crew.png",
  "so-back-tee.png",
  ...
  "women-vneck.png",
  "youth-utxo-tee.png",
  "bitcoin-daddy-tee.png",
  "bitcoin-mummy-tee.png",
  "bitcoin-daddy-longsleeve.png",
  "bitcoin-mummy-longsleeve.png",
  "hodl-tee.png",
  "hodl-tee-ink.png",
  "hodl-tee-navy.png",
  "strategic-reserve-tee.png",
  "hard-money-tee.png",
  "proof-tweet-tee.png",
  "btc-b-tee.png",
  "women-btc-tee.png",
  "verify-longsleeve.png",
