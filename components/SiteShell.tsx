  ...
  return (
    <CartHydrate>
      <div className="min-h-screen overflow-x-hidden bg-ink">
        <div className="border-b border-ember/40 bg-surface px-4 py-2 text-paper md:px-6">
          <p className="min-w-0 truncate text-center font-mono text-[10px] uppercase tracking-[0.2em] text-paper sm:whitespace-normal">
