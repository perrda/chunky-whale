...
export const RETIRED_SLUGS = new Set([
  ...
  "b-beanie",
  "hodl-swim-shorts",
  "stack-sats-swim-shorts",
  "21m-board-shorts",
  "hard-money-swim-shorts",
  "btc-rash-guard",
  "hodl-bikini",
  "stack-sats-bikini",
  "few-understand-bikini",
  "21m-one-piece",
  "stay-humble-one-piece",
  "women-btc-rash-guard",
  "stack-sats-youth-swim",
  "orange-daily-youth-swim",
  "future-utxo-youth-rash",
  "node-toddler-swim",
  "hodl-swim-cap",
  "stack-sats-swim-cap-women",
  "21m-swim-cap-youth",
  "bitcoin-daddy-tote",
  "bitcoin-mummy-tote",
  "hard-money-tote",
